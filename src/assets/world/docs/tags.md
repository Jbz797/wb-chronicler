...
| Tag                         | Signification                                                                                                                                        |
| --------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------- |
| `DISABLE_DROP_OF_THOUGHTS`  | Le monde atteint son quota de royaumes sapients (un par 52 044 tuiles de terre, 2 au moins) et la loi **Drop of Thoughts** tourne encore → à couper. |
| `DISABLE_HANDSOME_MIGRANTS` | Au moins autant de ces royaumes comptent 4 habitants ou plus, **dont celui du favori**, et la loi **Handsome Migrants** tourne encore → idem.        |
...
Les deux `DISABLE_*` décrivent un **état**, non un événement : ils reviennent tant que le joueur n'a pas coupé la loi, et s'effacent dès qu'il le fait — ou dès que la condition tombe.
