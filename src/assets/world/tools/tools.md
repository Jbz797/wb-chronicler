...
<p class="metadata">Date de mise à jour : 17/08/26 19:20</p>
...
| `clan/info.py <id>`                | `full`, `breakdown`, `identity`, `members`, `metadata`, `population`, `ranks`, `traits`                                               |
| `family/info.py <id>`              | `full`, `breakdown`, `identity`, `members`, `metadata`, `population`, `ranks`                                                         |
...
| `subspecies/info.py <id>`          | `full`, `breakdown`, `identity`, `members`, `metadata`, `population`, `ranks`, `species`, `taxonomy`, `traits`                        |
